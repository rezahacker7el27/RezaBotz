...
cr = '*REZA Bot By RezaGanz*'
vr = '*REZA Bot Wa*\n*Subscribe My Channel Reza FF*'

//owner number
const ownerNumber = ["6283152022074@s.whatsapp.net"]  //Ganti Jadi Nomormu
